...
CREATE TABLE YARPG.MAP_ELEMENT (
...
ALTER TABLE YARPG.MAP_ELEMENT ADD CONSTRAINT MAP_ELEMENT_PK PRIMARY KEY (ID);

CREATE SEQUENCE YARPG.MAP_ELEMENT_ID_SEQ MINVALUE 1 NOMAXVALUE INCREMENT BY 1 START WITH 1 CACHE 10 CYCLE;
